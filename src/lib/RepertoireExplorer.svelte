  ...
  {:else if data}
    <div class="filters-container">
      ...
      <div class="filter-row">
        ...
        <div class="filter-group">
          <label for="difficulty-min">Vanskelighetsgrad (1-6)</label>
          <div class="range-inputs">
            <input id="difficulty-min" type="number" placeholder="Min" bind:value={minDifficulty} min="1" max="6" />
            <span>—</span>
            <input id="difficulty-max" type="number" placeholder="Maks" bind:value={maxDifficulty} min="1" max="6" />
          </div>
        </div>
        ...
        <div class="filter-group">
          ...
          <div class="range-inputs">
            <input id="year-min" type="number" placeholder="Fra" bind:value={minYear} min="1770" max="2025" />
            <span>—</span>
            <input id="year-max" type="number" placeholder="Til" bind:value={maxYear} min="1770" max="2025" />
          </div>
        </div>
      ...
      <table class="repertoire-table">
        ...
        <tbody>
          {#each paginatedPieces as piece (piece.url)}
            <tr>
              <td class="title-cell" data-label="Tittel">{piece.title}</td>
              <td class="composer-cell" data-label="Komponist">{piece.composer || '—'}</td>
              <td class="duration-cell" data-label="Varighet">{formatDuration(piece.duration_minutes)}</td>
              <td class="difficulty-cell" data-label="Grad">{piece.difficulty_roman || '—'}</td>
              <td class="year-cell" data-label="År">{formatYears(piece.years)}</td>
...
<style>
  ...
  @media (max-width: 640px) {
    ...
    .repertoire-table td[data-label]::before {
